...
Select “Transaction pooler” in menu
...
## Try the live polling demo

Drop your `.env` file into the `part-3-live-polling` example and view live data summarised inside the survey!
